...
/**
 * This is the item provider adapter for a {@link doecode.Record} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Record_org_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Record_org_feature", "_UI_Record_type"),
				 DoecodePackage.Literals.RECORD__ORG,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addSoftwarePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Record_software_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Record_software_feature", "_UI_Record_type"),
				 DoecodePackage.Literals.RECORD__SOFTWARE,
				 true,
				 false,
				 true,
				 null,
